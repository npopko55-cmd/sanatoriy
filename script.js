...
/* ---------- Онлайн-Санаторий: обратный отсчёт до старта (13 июля) ---------- */
(function () {
  var target = new Date('2026-07-13T00:00:00+03:00').getTime();
  ...
  function tick() {
    ...
    if (diff <= 0) {
      ...
      if (txt) txt.innerHTML = 'Санаторий уже открыт — <strong>присоединяйся</strong>';
